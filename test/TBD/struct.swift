...
// RUN: %target-swift-frontend -target $DARWIN_TARGET -emit-ir -o/dev/null -parse-as-library -module-name test -validate-tbd-against-ir=all %s -enable-library-evolution
...
// RUN: %target-swift-frontend -target $DARWIN_TARGET -emit-ir -o/dev/null -parse-as-library -module-name test -validate-tbd-against-ir=all %s -enable-library-evolution -enable-testing
...
// RUN: %target-swift-frontend -target $DARWIN_TARGET -emit-ir -o/dev/null -parse-as-library -module-name test -validate-tbd-against-ir=all %s -enable-library-evolution -O
...
// RUN: %target-swift-frontend -target $DARWIN_TARGET -emit-ir -o/dev/null -parse-as-library -module-name test -validate-tbd-against-ir=all %s -enable-library-evolution -enable-testing -O
